...
example.controller("LoginController", function($scope) {
    ...
    $scope.login = function() {
        ...
        var client_id = "227NPW";
        var redirect_uri = "http%3A%2F%2Fceclnx01.cec.miamioh.edu%2Fusers%2Fhughese%2Fcec205%2Fsite%2Foauth_callback.html";
...
example.controller("SecureController", function($scope) {
    ...
    // Make calls with the accesstoken either here or with inline js in ../templates/secure.html
    ...
    xhttp.onreadystatechange = function() {
       if (xhttp.readyState == 4 && xhttp.status == 200) {
          $scope.activity = JSON.parse(xhttp.responseText).activities.steps;

          // Use angular to get the div to change
          var myElement = angular.element( document.querySelector('#selector'));
          myElement.text($scope.activity);
       }
    };
